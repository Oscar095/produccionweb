...
import { streamChat, type ChatMessage, type ChatEvent } from '../api/koski_ia'
...
export default function Chat() {
  ...
  const send = async (prompt: string) => {
    ...
    try {
      await streamChat(history, { onEvent, signal: ctrl.signal })
    } catch (e: unknown) {
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-blue-200 text-sm mt-0.5">
              Consulta producción y planeación en lenguaje natural — Gemini 2.5
            </p>
          </div>
          {messages.length > 0 && (
            <button
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {messages.length === 0 && (
            <div className="text-center py-10">
              ...
              <p className="text-sm text-slate-500 mt-1 mb-6">Pregúntame sobre producción, máquinas, capacidad o planeación.</p>
